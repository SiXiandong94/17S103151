// MultiProtoclServer.cpp: implementation of the P2PServer class.
//
//////////////////////////////////////////////////////////////////////
...
void P2PServer::CheckCommand(SOCKET s,char *p,int nPacketLen)
{
	int nOffset;
	PCLIST *ptr_pc;
...
void P2PServer::CheckClientList()
{
    int nRet;
